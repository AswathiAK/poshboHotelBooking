  ...
  return (
    <div className="pt-5 h-full flex relative" >
      ...
      <div className="pl-2 w-1/4">
        <div className="h-1/2 ">
          <img src={property.photos?.[1]} alt="2nd photo" className='w-full h-full object-cover' />
        </div>
        <div className="h-1/2 pt-2">
          <img src={property.photos?.[2]} alt="3rd photo" className='w-full h-full object-cover' />
        </div>
      </div>
      <div className="pl-2 w-1/4 ">
        <div className="h-1/2 rounded-tr-lg">
          <img src={property.photos?.[3]} alt="4th photo" className='w-full h-full object-cover rounded-tr-lg' />
        </div>
