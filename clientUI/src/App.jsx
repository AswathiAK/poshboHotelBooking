      ...
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          <Route element={<GuestPrivateRoute />}>
            ...
            <Route
              path="/search_results"
              element={<SearchResultsHotelsPage />}
            />
          ...
          <Route element={<GuestProtectedRoute />}>
            ...
            <Route
              path="/account/inbox/messages"
              element={<GuestMessagePage />}
            />
        ...
        <Route element={<HostProtectedRoute />}>
          ...
          <Route
            path="/host/view_properties"
            element={<ViewPropertiesPage />}
          />
          <Route
            path="/host/view_property/:id"
            element={<ViewSinglePropertyPage />}
          />
          <Route
            path="/host/edit_property/:id"
            element={<EditPropertyPage />}
          />
          <Route path="/host/account/:active" element={<HostProfilePage />} />
          <Route path="/host/messages" element={<HostMessagePage />} />
          <Route
            path="/host/:bookingType/:hotelId"
